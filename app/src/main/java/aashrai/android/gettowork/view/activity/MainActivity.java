...
public class MainActivity extends BaseActivity
    ...
    ImageView activate;
    @BindView(R.id.rv_timing_grid)
    RecyclerView timingsRecyclerView;
    @BindView(R.id.tv_pauseWarning)
    TextView pauseWarning;
    @BindView(R.id.tv_activateHeader)
    TextView activateHeader;
    ...
    @NonNull
    private GridLayoutManager getTimingLayoutManager() {
    ...
    @NonNull
    private TimingGridAdapter getTimingGridAdapter() {
        List<String> timings =
    ...
    @Override
    public void setActivateDrawable(Drawable drawable) {
